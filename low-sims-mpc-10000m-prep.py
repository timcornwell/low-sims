...
if __name__ == '__main__':
    ...
    export_skymodel_to_hdf5(gleam_skymodel_noniso, 'low-sims-noniso_skymodel.hdf5')
    export_skymodel_to_hdf5(gleam_skymodel_iso, 'low-sims-iso_skymodel.hdf5')
    ...
    export_blockvisibility_to_hdf5(all_skymodel_iso_blockvis,
                                   'low-sims-skymodel_iso_blockvis_rmax%.1f.hdf5' % rmax)
    ...
    export_blockvisibility_to_hdf5(all_skymodel_noniso_blockvis,
                                   'low-sims-skymodel_noniso_blockvis_rmax%.1f.hdf5' % rmax)
