...
if __name__ == "__main__":
    ...
    theta_list = import_skymodel_from_hdf5("results/low-sims-mpc-skymodel_%dsources_iteration0.hdf5" % (nsources))
    ...
    export_skymodel_to_hdf5(theta_list,
                            "results/mpc-skymodel_%dsources_iteration%d_rmax%.1f.hdf5" % (nsources, 10, rmax))
