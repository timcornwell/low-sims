...
# #### Construct the skymodels, $\theta_p^{(0)}$, based on the Voronoi decomposition of the components.
# Each skymodel will contain a mask based on the decomposition, an image and gaintable derived from ICAL
